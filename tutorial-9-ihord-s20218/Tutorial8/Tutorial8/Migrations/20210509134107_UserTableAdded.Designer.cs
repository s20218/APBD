...
namespace Tutorial9.Migrations
{
    ...
    [Migration("20210509134107_UserTableAdded")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Tutorial9.Models.Prescription_Medicament", b =>
                {
                    b.Property<int>("IdMedicament")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Tutorial9.Models.UserTb", b =>
                {
                    b.Property<int>("IdUserTb")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Tutorial9.Models.Prescription", b =>
                {
                    b.HasOne("Tutorial9.Models.Doctor", "IdDoctorNavigation")
                        .WithMany("Prescriptions")
                        .HasForeignKey("IdDoctor")
                        .HasConstraintName("Prescription_Doctor")
                        .IsRequired();

                    b.HasOne("Tutorial9.Models.Patient", "IdPatientNavigation")
                        .WithMany("Prescriptions")
            ...
            modelBuilder.Entity("Tutorial9.Models.Prescription_Medicament", b =>
                {
                    b.HasOne("Tutorial9.Models.Medicament", "IdMedicamentNavigation")
                        .WithMany("Prescription_Medicaments")
                        .HasForeignKey("IdMedicament")
                        .HasConstraintName("Prescription_Medicament_Medicament")
                        .IsRequired();

                    b.HasOne("Tutorial9.Models.Prescription", "IdPrescriptionNavigation")
                        .WithMany("Prescription_Medicaments")
