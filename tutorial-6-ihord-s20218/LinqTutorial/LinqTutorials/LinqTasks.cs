...
namespace LinqTutorials
{
    public static class LinqTasks
    {
        ...
        {
            IEnumerable<Emp> result = null;
            result = Emps.Where(e => e.Job == "Frontend programmer" && e.Salary > 1000).OrderByDescending(e => e.Ename);
            return result;
        }
        ...
        {
            IEnumerable<object> result = null;
            result = Emps.Join(Depts, e => e.Deptno, d => d.Deptno, (e, d) => new
            {
                e.Ename,
                e.Job,
                d.Dname
        ...
        public static IEnumerable<object> Task7()
        {
            ...
            result = Emps.GroupBy(e => e.Job).Select(gr => new
            {
                Praca = gr.Key,
        ...
        {
            Emp result = null;
            result = Emps.OrderByDescending(e => e.HireDate).Where(e => e.Job == "Frontend programmer").FirstOrDefault();
            return result;
        }
        ...
        public static IEnumerable<object> Task10()
        {
            ...
            result = Emps.Select(e => new { e.Ename, e.Job, e.HireDate })
        ...
        {
            IEnumerable<object> result = null;
            result = Emps.GroupBy(e => e.Deptno).Select(gr => new
            {
                gr.Key,
                numOfEmployees = gr.Count()
            }).Join(Depts, gr => gr.Key, d => d.Deptno, (gr, d) => new
            {
                name = d.Dname,
                gr.numOfEmployees
        ...
        {
            int result = 0;
            result = arr.GroupBy(i => i).Where(gr => gr.Count() % 2 != 0).
                         Select(gr => gr.Key).Single();
            return result;
        }
        ...
        public static IEnumerable<Dept> Task14()
        {
            ...
            result = Depts.Where(d => Emps.Count(e => e.Deptno == d.Deptno) == 5 ||
                                      !Emps.Select(e => e.Deptno).Contains(d.Deptno)).OrderBy(d => d.Deptno);
    ...
    public static class CustomExtensionMethods
    {
        ...
        public static IEnumerable<Emp> GetEmpsWithSubordinates(this IEnumerable<Emp> emps)
        {
            ...
            result = emps.Where(e => emps.Count(e1 => e1.Mgr == e) >= 1).OrderBy(e => e.Ename).ThenByDescending(e => e.Salary);
